...
def registro():
    ...
    pantalla1.geometry("300x500")   #Creamos la ventana
    
    #--------- Empezaremos a crear las entradas ----------------------------------------
    
    usuario = StringVar()
    contra = StringVar()
    Label(pantalla1,text = "Bienvenido a Registro de Usuario", fg="white", bg = "blue", width = "300", height = "2", font = ("Time New Roman", 13)).pack() #Asignamos caracteristicas de la ventana
    Label(pantalla1,text = "El nombre de usuario es Requerido", fg="white", bg = "blue", width = "300", height = "2", font = ("Time New Roman", 13)).pack() #Asignamos caracteristicas de la ventana

    Label(pantalla1, text = "").pack()  #Dejamos un poco de espacio
    Label(pantalla1, text = "Nombre de Usuario").pack()  #Mostramos en la pantalla 1 el usuario
    ...
    Button(pantalla1, text = "Registro con Contraseña", command = registrar_usuario).pack()  #Creamos el boton

    #------------ Vamos a crear el boton para hacer el registro facial --------------------
    Label(pantalla1, text = "").pack()
    Button(pantalla1, text = "Registro con Rostro", command = registro_facial).pack()
...
def login():
    ...
    pantalla2.geometry("300x500")   #Creamos la ventana
    Label(pantalla2,text = "Bienvenido a Inicio de Sesión", fg="white", bg = "blue", width = "300", height = "2", font = ("Time New Roman", 13)).pack() #Asignamos caracteristicas de la ventana
    Label(pantalla2,text = "Para iniciar sesion con rostro se necesita el nombre de usuario", fg="white", bg = "blue", width = "300", height = "2", font = ("Time New Roman", 8)).pack() #Asignamos caracteristicas de la ventana
    ...
    Button(pantalla2, text = "Iniciar Sesión con Contraseña", command = verificacion_login).pack()

    #------------ Vamos a crear el boton para hacer el login facial --------------------
    Label(pantalla2, text = "").pack()
    Button(pantalla2, text = "Iniciar Sesión con Rostro", command = login_facial).pack()
...
def pantalla_principal():
    ...
    pantalla.title("FacePay")       #Asignamos el titulo de la pantalla
    Label(text = "Bienvenido a FacePay", fg="white", bg = "blue", width = "300", height = "2", font = ("Time New Roman", 13)).pack() #Asignamos caracteristicas de la ventana
    
#------------------------- Vamos a Crear los Botones ------------------------------------------------------
    
    Label(text = "\n\n\n\n\n\n").pack()  #Creamos el espacio entre el titulo y el primer boton
    Button(text = "Iniciar Sesion", height = "2", width = "30", relief="ridge",command = login).pack()
    Label(text = "").pack() #Creamos el espacio entre el primer boton y el segundo boton
    Button(text = "Registro", height = "2", width = "30",relief="ridge", command = registro).pack()
...
def pantalla_dashboard():
    global pantalla3
    pantalla3 = Tk()
    pantalla3.geometry("300x500")  #Asignamos el tamaño de la ventana 
    pantalla3.title("Dashboard")       #Asignamos el titulo de la pantalla
    Label(pantalla3, text = "Bienvenido a Dashboard", fg="white", bg = "blue", width = "300", height = "2", font = ("Time New Roman", 13)).pack() #Asignamos caracteristicas de la ventana
    
#------------------------- Vamos a Crear los Botones ------------------------------------------------------
    Label(pantalla3, text = "Continuará...", height = "2", width = "30",relief="ridge").pack()
